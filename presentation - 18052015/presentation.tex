...
\only<1> {\includegraphics[height=4cm]{ColorDiff.png}} % Changer l'image
\item<2-> The C$_2$O matrix in a 3-D repository.
\only<2> {\includegraphics[height=4cm]{C2OMatrix.png}}
\end{itemize}
...
\only<1> {\includegraphics[height=5cm]{Spherical_Coordinates.png}} % Changer l'image
\item<2-> Quantization for one $\beta$ interval.
\only<2> {\includegraphics[height=5cm]{QuantificationSphericToHist1.png}}
\item<3-> Histogram obtained for one $\beta$ interval.
\only<3> {\includegraphics[height=4cm]{QuantificationSphericToHist2.png}}
\item<4-> Quantization for each $\beta$ interval.
\only<4> {\includegraphics[height=5cm]{QuantificationSphericToHist3.png}}
\item<5-> Final signature obtained.
\only<5> {\includegraphics[height=3.5cm]{QuantificationSphericToHist4.png}}
...
\only<1> {\includegraphics[height=3.7cm]{trello1.png}} % Changer l'image
\only<2> {\includegraphics[height=4cm]{trello2.png}}
\only<3> {\includegraphics[height=4cm]{trello3.png}}
\end{itemize}

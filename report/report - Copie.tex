...
\item ObservationId: the plant observation ID from which several pictures can be associated;
    \begin{figure}[H]
      \centering
...
\item content: what part of the plant it is : "Leaf", "Flower", "Fruit", "Stem", "Entire", "Branch";
...
\item author: name of the author of the picture;
\end{itemize}
...
\subsubsection{metadata retrievers}
    Every picture of the dataset was bundled with a XML file providing related data.
    Retrieving relevant data from those files was necessary in order to build run files and in order to calculate the metrics of the challenge.

...
For each sprint beginning, the team look at the backlog and affect to the sprint the higher prioritized tasks which are remaining to do to the sprint. You could see below a sample of the backlog of our project: (BACKLOG SCREENSHOT)
...
You can see below our Trello board for the sprint 4 : (TRELLO SCREENSHOT)
